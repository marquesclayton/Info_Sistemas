...
interface
    ...
    uses UBaseModelName, UBaseModelJson, XMLDoc, XMLIntf, Classes;
...
type
    TClientModel = class(TBaseModelName)
        ...
        public
            ...
            function getXML(Aowner: TComponent): TXMLDocument; override;
...
function TClientModel.getXML(Aowner: TComponent): TXMLDocument;
var
  XMLDocument: TXMLDocument;
  mainNode, detailNode, addressNode: IXMLNode;
begin
    XMLDocument := TXMLDocument.Create(Aowner);
